...
CC=LANG=C gcc
RM=rm
CFLAGSDEBUG=-std=c11 -Wall -ggdb -O0 -march=native -fbuiltin -W -Wstrict-prototypes -Wreturn-type -Wsequence-point -pedantic -Wextra -I/usr/include/libxml2/ -fstack-protector-all -p
